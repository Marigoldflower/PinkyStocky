...
enum FinancialNewsNetworkError: Error {
...
final class FinancialNewsDataNetworkMananger {
    ...
    typealias NetworkCompletion = (Result<NewsCollection, FinancialNewsNetworkError>) -> Void
    ...
    func fetchNetwork(searchTerm: String, apiKey: String, completion: @escaping NetworkCompletion) {
        ...
        let urlString = "https://finnhub.io/api/v1/news?category=\(searchTerm)&token=\(apiKey)"
        print(urlString)
