...
final class WorldWideNewsDataNetworkManager {
    ...
    func fetchNetwork(searchTerm: String, completion: @escaping NetworkCompletion) {
        ...
        let myAPIKey = "c23c0a90bd3243fc83bf0445986eed51"
        
        let urlString = "https://api.worldnewsapi.com/search-news?text=\(searchTerm)&source-countries=us&language=en&earliest-publish-date=\(earliestPublishDate)&api-key=c23c0a90bd3243fc83bf0445986eed51"
        print(urlString)
