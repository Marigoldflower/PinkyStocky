...
enum NewsDataNetworkError: Error {
...
final class CompanyNewsDataNetworkManager {
    ...
    typealias NetworkCompletion = (Result<NewsDataArchive, NewsDataNetworkError>) -> Void
    ...
    private func parseJSON(_ newsData: Data) -> [CompanyNewsData]? {
        //print(#function)
